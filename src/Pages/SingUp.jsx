  ...
  return (
    <div>
      <div className='flex items-center'>
          ...
          <h2 className="mb-6 text-3xl font-bold text-center text-gray-800">Singup</h2>
          
          <form className="space-y-6">
        
          <div>
              <label for="email" className="block text-sm font-medium text-gray-700">User Name</label>
              <input
                type="text"
                id="username"
